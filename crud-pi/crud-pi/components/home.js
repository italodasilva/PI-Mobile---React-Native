...
export default class Home extends React.Component {
    ...
    return (
      <TouchableOpacity style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
        <View style={{ width: '80%'}} >
          ...
          <Text style={css.letras}>Disciplina: {item.disciplina}</Text>
          <Text style={css.letras}>RA administrador: {item.raadmin}</Text>
        </View>
  ...
  render() {
    return (
      <View>
        <Button color="black"  title="Adicionar Professor" onPress={this.buttonAdicionar}/>
